...
var storylineApp = angular.module('storylineApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'storylineAppUtils', 'pascalprecht.translate', 'truncate']);
